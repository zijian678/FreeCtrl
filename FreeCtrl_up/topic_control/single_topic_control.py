...
# Basic setting
parser = argparse.ArgumentParser(description='FreeCtrl: topic control')
...
parser.add_argument('--sentence_thre', type=float, default=1.07, help='sentence threshold u_w')
parser.add_argument('--k_values', type=int, default=30, help='maximum number of value vectors for each keyword')
parser.add_argument('--lamda', type=float, default=0.30, help='scaling parameter')
parser.add_argument('--label_word_file', type=str, default="topic_words.txt", help='label keyword file')

# task setting
parser.add_argument('--label_id', type=int, default=3, help='label id for generation') # 0- 3 for ['politics','sports','business','technology']
...
## obtain class repre
class_name = ['politics','sports','business','technology']
